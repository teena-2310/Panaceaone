...
<div className="about-why-us">
  ...
  <div className="why-us-grid">
    <div className="why-us-card">
      <img src="https://img.icons8.com/fluency/96/nature.png" alt="Holistic Healing" />
      <h3>Holistic Healing</h3>
      <p>We integrate mind, body, and soul to create complete wellness solutions.</p>
    </div>
    <div className="why-us-card">
      <img src="https://img.icons8.com/fluency/96/leaf.png" alt="Natural Ingredients" />
      <h3>Natural Ingredients</h3>
      <p>All therapies and remedies are made from 100% natural and safe ingredients.</p>
    </div>
    <div className="why-us-card">
      <img src="https://img.icons8.com/fluency/96/teacher.png" alt="Experienced Practitioners" />
      <h3>Experienced Practitioners</h3>
      <p>Our team includes trained professionals in Reiki, Pranic Healing, and Energy Healing.</p>
    </div>
    <div className="why-us-card">
      <img src="https://img.icons8.com/fluency/96/user-settings.png" alt="Personalized Care" />
      <h3>Personalized Care</h3>
      <p>Each session is tailored to your individual needs for maximum benefit.</p>
    </div>
  </div>
</div>
      </div>
